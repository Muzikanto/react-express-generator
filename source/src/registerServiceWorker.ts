// In production, we register a service worker to serve Navbar.assets from local cache.
...
export function register() {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      ...
      // serve Navbar.assets; see https://github.com/facebookincubator/create-react-app/issues/2374
      return;
    }
